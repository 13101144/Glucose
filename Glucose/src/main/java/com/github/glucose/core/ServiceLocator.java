...
import com.github.glucose.filter.Filter;
...
public interface ServiceLocator {
     ...
     */
    public List<ComponentModel> getDescriptors(Filter filter);
     ...
     */
    public ComponentModel getBestDescriptor(Filter filter);
     ...
     */
    public ComponentModel reifyDescriptor(ComponentModel descriptor, DependencyModel injectee) throws MultiException;
     ...
     * @throws MultiException if there were errors when loading or analyzing the class
     */
    public ComponentModel reifyDescriptor(ComponentModel descriptor) throws MultiException;
     ...
     * @throws MultiException if there were errors when loading or analyzing the class
     */
    public ComponentModel getInjecteeDescriptor(DependencyModel injectee) throws MultiException;
     ...
     * @throws MultiException if there was an error during service creation
     */
    public <T> ServiceHandle<T> getServiceHandle(ComponentModel activeDescriptor, DependencyModel injectee) throws MultiException;
     ...
     * @throws MultiException if there was an error during service creation
     */
    public <T> ServiceHandle<T> getServiceHandle(ComponentModel activeDescriptor) throws MultiException;
     ...
     * @throws MultiException if there was an error during service creation
     */
    public <T> T getService(ComponentModel activeDescriptor, ServiceHandle<?> root) throws MultiException;
